...
%     f2=wmin+(wspeed_min-wmin)*(z-1)/m;
    ...
    Kfi2(z,j)=0;
    I=1;
    [Kfi1(z,j)]=Time_erfenfa1_down(windspeed(i,:),f1,I,Kfi2(z,j));%风机1的系数
    while(1)
     I=0;
    [Kfi2(z,j+1)]=Time_erfenfa1_down(windspeed(i,:),f2,I,Kfi1(z,j));%风机2的系数
     I=1;
    [Kfi1(z,j+1)]=Time_erfenfa1_down(windspeed(i,:),f1,I,Kfi2(z,j+1));
 ...
 [wspeed,frequency,Pe,Pei] = Windfarm_down_new(X2(i,:),Kfi_N((i-1)*h+z,:));
